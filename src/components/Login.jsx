...
export default function Login() {
    ...
    async function handleGoogleSignIn() {
        try {
            ...
            setError('Failed to sign in. Check your connection or try again.');
            console.error(err);
        }
    }
        ...
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <button onClick={handleGoogleSignIn} className={styles.googleBtn}>
                    <svg className={styles.icon} viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
